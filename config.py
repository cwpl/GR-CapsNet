...
train_arg.add_argument('--init_lr', type=float, default=0.04,
                       help='Initial learning rate value')
train_arg.add_argument('--train_patience', type=int, default=100,
                       help='Number of epochs to wait before stopping train')
train_arg.add_argument('--dataset', type=str, default='fashionmnist',
                       help='Dataset for training: {fashionmnist}')
...
train_arg.add_argument('--depth', type=int, default=2,
                       help="depth of additional layers")


# other params
misc_arg = add_argument_group('Misc.')
misc_arg.add_argument('--name', type=str, default='resnet_global_routing',
...
misc_arg.add_argument('--data_dir', type=str, default='/home/zhao/CR/datasets/data', #/home/zhao/CR/datasets/data   D:/Dateset
...
train_arg.add_argument('--exp', type=str, default='full',
...
misc_arg.add_argument('--view', type=str2bool, default=False,
                      help='Whether to generate view')
